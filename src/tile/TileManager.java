...
public class TileManager {
    ...
    public void getTileImage() throws IOException {
        ...
        // Tile 6 - normal chest
        tiles[6] = new Tile();
        tiles[6].image = ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResource("res/tiles/newTiles/place/chest/commonGrass.png")));
        ...
        tiles[21] = new Tile();
        tiles[21].image = ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResource("res/tiles/newTiles/place/chest/legenGrass.png")));
        tiles[21].collision = true;

        // Tile 22 - rare chest
        tiles[22] = new Tile();
        tiles[22].image = ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResource("res/tiles/newTiles/place/chest/rareGrass.png")));
