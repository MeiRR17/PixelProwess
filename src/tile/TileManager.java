...
public class TileManager {
    ...
    public TileManager(GamePanel gamePanel) throws IOException {
        ...
        tiles = new Tile[40]; // Assume max 10 types of tiles
        ...
        load("/maps/mapv2.txt"); // Load the map layout
    }
    ...
    public void getTileImage() throws IOException {
        ...
        tiles[15] = new Tile();
        tiles[15].image = ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResource("tiles/newTiles/ground/water/cliff/outward/lefft_down.png")));
